...
class brightness {
    ...
    public function __construct($brightnessArg, $img_nameArg, $ajaxArg = false) {
        $this->brightness_lvl = $brightnessArg;
    ...
    public function adjustBrightness() {
        if (imagefilter($this->image, IMG_FILTER_BRIGHTNESS, $this->brightness_lvl)) {
            if($this->ajax === true) {
            ...
            $this->errors['brightness_error'] = "error occurred while adjusting brightness level of a image";
